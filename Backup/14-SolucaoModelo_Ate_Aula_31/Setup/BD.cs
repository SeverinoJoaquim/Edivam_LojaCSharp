...
namespace Setup
{
    public class BD
    {
        ...
        public static void EmailAdmin(string Login, string Senha, string Acao, string Funcao, int Tentativa)
        {
            using (SmtpClient s = new SmtpClient())
            {
                ...
                using (MailMessage m = new MailMessage())
                {
                    ...
                    m.To.Add(new MailAddress("severinojoca@gmail.com"));

                    m.Subject = "Tentativa de " + Acao + " nº " + Tentativa;
